...
public class spacuninstall extends AppCompatActivity implements View.OnClickListener {
    Button bt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_spacuninstall);
        firebaseAuth = FirebaseAuth.getInstance();
        if (firebaseAuth.getCurrentUser() == null) {
            finish();
            startActivity(new Intent(spacuninstall.this, login.class));
        }
    ...
    private void saveNumberAndPrice(){
        ...
        if (r1.isChecked()) {
            ...
            finish();
            startActivity(new Intent(spacuninstall.this, location.class));
        }
        if (r2.isChecked()) {
