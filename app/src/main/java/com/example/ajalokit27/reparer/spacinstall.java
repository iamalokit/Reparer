...
public class spacinstall extends AppCompatActivity implements View.OnClickListener {
    Button bt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (firebaseAuth.getCurrentUser() == null) {
            finish();
            startActivity(new Intent(spacinstall.this, login.class));
        }
    ...
    private void saveNumberAndPrice(){
        ...
        if (r1.isChecked()) {
            ...
            finish();
            startActivity(new Intent(spacinstall.this, location.class));
        }
        if (r2.isChecked()) {
